...
The data architecture utilizes a multi-fact relational data model (Galaxy Schema) built within Tableau's logical layer, connecting core transactional tables with descriptive lookup dimensions:
